...
int main()
{
    ...
    /* Read the Kernel */
    program_handle = fopen("/Users/Master/Desktop/ICG_PROJECT/Cornell_OpenCLGrid/Cornell_OpenCLGrid/radianceGPU.cl", "r");       // YOUR PATH TO KERNEL
    if (!program_handle)
    ...
    FILE *f = fopen("/Users/Master/Desktop/ICG_PROJECT/Cornell_OpenCLGrid/Cornell_OpenCLGrid.ppm", "w");         // Write image to PPM file.   // YOUR PATH TO IMAGE
    fprintf(f, "P3\n%d %d\n%d\n", width, height, 255);
